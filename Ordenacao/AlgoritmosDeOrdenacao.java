...
public class AlgoritmosDeOrdenacao {
    ...
    public void insertionSort() {
        int carta, it, j;
        // a iteracao vai "selecionar a carta da vez" e ai, tenho que "puxar" todos os elementos maiores  que eles
    ...
    public int partition(int inicio, int fim) {
        ...
        while (down < up) {
            ...
            while (vetor[down] <= ref && down < fim) {
                down++; //avanco pq quero encontrar um valor maior
            }
            // tambem quero encontrar a partir do fim um valor menor que o meu ref
            while (vetor[up] > ref) {
                up--;
            }
            if (down < up) { // eles nao se cruzaram nos indices
                //troca
        ...
        return up; //no final das contas é a  posicao de UP que denota onde esta o pivot
    }
